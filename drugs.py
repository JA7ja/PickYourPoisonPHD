...
def get_drug(symptom):
    ...
    return drug_list[x]['name'],  drug_list[x]['side_effects']
    
print(get_drug("hypertension"))
print(get_drug("adhd"))
print(get_drug("anxiety"))
print(get_drug("chest pain"))
print(get_drug("eye pressure"))
print(get_drug("nausea"))
print(get_drug("fever"))
print(get_drug("rheumatic fever"))
print(get_drug("vomiting"))
print(get_drug("cough"))
print(get_drug("hoarseness"))
print(get_drug("itching"))
print(get_drug("bites"))
print(get_drug("stings"))
print(get_drug("rash"))
print(get_drug("allergies"))
print(get_drug("pain"))
print(get_drug("muscle cramps"))    
